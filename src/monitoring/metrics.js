...
const subscriptionStarted = meter.createCounter('gql_subscription_started', { description: 'The number of subscriptions.' })

async function startServer() {
  await exporter.startServer()
  console.log(`🚀 Metrics server ready at http://localhost:${port}${endpoint}`)
}
